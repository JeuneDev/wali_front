        ...
        <footer className="footer">
            <div className="container">
                <div className="footer-content">
                    ...
                    {/* Column 2 - Candidats */}
                    <div className="footer-column">
                        <h4 className="footer-title">Candidats</h4>
                        <ul className="footer-links">
                            <li><Link to="/jobs">Rechercher un emploi</Link></li>
                            <li><Link to="/profile">Créer un profil</Link></li>
                            <li><Link to="/cv">Conseils CV</Link></li>
                        </ul>
                    </div>

                    {/* Column 3 - Recruteurs */}
                    <div className="footer-column">
                        <h4 className="footer-title">Recruteurs</h4>
                        <ul className="footer-links">
                            <li><Link to="/post-job">Publier une offre</Link></li>
                            <li><Link to="/pricing">Tarifs</Link></li>
                            <li><Link to="/recruiter">Rechercher des candidats</Link></li>
                        </ul>
                    </div>
